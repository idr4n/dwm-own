...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { col_gray1, col_gray4,  col_gray1}, // Tagbar left selected {text,background,not used but cannot be empty}
...
const char *spcmd3[] = {"st", "-n", "spt2", "-g", "130x32", "-e", "/home/iduran/scripts/dailynote", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_j,      floatbig, 			 {0} },
	{ MODKEY|ControlMask,           XK_k,      floatmedium,		 {0} },
	{ MODKEY|ControlMask,           XK_s,      floatsmall, 		 {0} },
